...
export const TEXT_PRESETS: TextPreset[] = [
  // Trending & Modern
  {
    ...
    emoji: '🏢',
    description: 'Clean professional corporate look',
    category: 'Corporate',
    tag: 'Standard',
  ...
  },
  {
    name: 'FinTech Pulse',
    emoji: '💳',
    description: 'Crisp bold cobalt branding for payments',
    category: 'Corporate',
    tag: 'Finance',
  ...
  },
  {
    name: 'Smooth Velvet',
    emoji: '✨',
    description: 'Modern violet aesthetic with soft glow',
    category: 'Trending',
    tag: 'Modern',
    ...
    titleTextShadowColor: '#7C3AED35',
    titleTextShadowBlur: 8,
    captionFontFamily: 'Inter',
    captionFontSize: 12,
    captionFontWeight: '400',
    captionColor: '#A78BFA',
  ...
  },
  {
    name: 'Neon Matrix',
    emoji: '⚡',
    description: 'Electric emerald glow on dark background',
    category: 'Neon',
    tag: 'Cyber',
    ...
    titleSpacing: 16,
    titleTextShadow: true,
    titleTextShadowColor: '#00FF8860',
    titleTextShadowBlur: 10,
    ...
    captionAlign: 'center',
    captionSpacing: 12,
    captionTextShadow: true,
    captionTextShadowColor: '#00CCFF50',
    captionTextShadowBlur: 6,
  },
  {
    name: 'Royal Onyx',
    emoji: '👑',
    description: 'Deep amber luxury serif with warm tones',
    category: 'Luxury',
    tag: 'Gold',
  ...
  },
  {
    name: 'Boutique Serif',
    emoji: '🥂',
    description: 'Refined rose & burgundy editorial feel',
    category: 'Luxury',
    tag: 'Editorial',
    titleFontFamily: 'Georgia',
    titleFontSize: 24,
  ...
  },
  {
    name: 'Pure Minimal',
    emoji: '◻',
    description: 'Whisper-quiet lightweight typography',
    category: 'Minimal',
    tag: 'Subtle',
    titleFontFamily: 'Inter',
    titleFontSize: 16,
  ...
  },
  {
    name: '8-Bit Arcade',
    emoji: '🕹️',
    description: 'Vintage hacker monospace aesthetic',
    category: 'Retro',
    tag: 'Pixel',
  ...
  },
  {
    ...
    emoji: '📟',
    description: 'Antique parchment typewriter styling',
    category: 'Retro',
    tag: 'Classic',
  ...
  },
  {
    name: 'Synthwave Neon',
    emoji: '💖',
    description: 'Hot radiant magenta & cyan glow',
    category: 'Neon',
    tag: 'Vibrant',
    titleFontFamily: 'Impact',
    titleFontSize: 26,
    ...
    titleSpacing: 14,
    titleTextShadow: true,
    titleTextShadowColor: '#F43F5E60',
    titleTextShadowBlur: 12,
    captionFontFamily: 'Segoe UI',
    captionFontSize: 12,
  ...
  },
  {
    name: 'Heavy Impact',
    emoji: '🔥',
    description: 'High visibility urgent call-to-action',
    category: 'Trending',
    tag: 'Bold',
    titleFontFamily: 'Impact',
    titleFontSize: 30,
  ...
  },
  {
    name: 'Playful Pop',
    emoji: '🎨',
    description: 'Cheerful & friendly community typography',
    category: 'Creative',
    tag: 'Fun',
  ...
  },
  {
    name: 'Matcha Blossom',
    emoji: '🍵',
    description: 'Organic calming earth tones',
    category: 'Creative',
    tag: 'Organic',
    titleFontFamily: 'Dosis',
    titleFontSize: 24,
  ...
  },
  {
    name: 'Nordic Clean',
    emoji: '⚪',
    description: 'Crisp Scandinavian editorial precision',
    category: 'Minimal',
    tag: 'Clean',
    titleFontFamily: 'Inter',
    titleFontSize: 18,
