  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 pb-28 md:pb-8">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        {/* Right: Live Preview — first on mobile, second on desktop */}
        ...
        {/* Left: Logo Options — second on mobile, first on desktop */}
        <div className="lg:w-[45%] shrink-0 order-last lg:order-first">
          ...
          >
            <div className="flex items-center gap-2.5 mb-5">
              ...
              <h2 className="text-lg font-bold text-[var(--color-text)]">Customise Logo</h2>
            </div>
            <LogoTab />
          </div>
        </div>
      ...
      {/* Final step — only a download button, no continue */}
