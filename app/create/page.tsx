        ...
        {QR_TYPES.map((item) => {
          ...
          return (
            ...
            >
              ...
              {/* Icon / Spinner */}
              <div className={`w-12 h-12 sm:w-14 sm:h-14 rounded-xl flex items-center justify-center transition-all duration-200 ${isLoading
              ...
              <div className="flex flex-col items-center gap-1 text-center">
                <span className={`text-sm sm:text-base font-bold leading-snug transition-colors duration-200 ${isLoading ? 'text-[var(--color-secondary)] dark:text-[var(--color-tertiary)]' : 'text-[var(--color-text)]'
                  }`}>
